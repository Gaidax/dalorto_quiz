module question_scenes {
    ...
    export class ResultScene extends createjs.Container {
        ...
        private label_cont:createjs.Container = new createjs.Container();
        ...
        constructor() {
            ...
            if(core.wrong_ones) {
              ...
              for(var wrong in core.wrong_ones){
                  ...
                  this.label_cont.addChild(que, que.double, ris, ris.double, ans, ans.double, esa, esa.double,
                  rig, rig.double);
                  this.results = esa;
              }
            var self = this;
        ...
        private label_it(str: string, color: string, y:number, x?: number): objects.Label {
            if(x) 
                return new objects.Label(str, "20px", 
                                  "Intubli_q", color, x, y, true);
             else
            return new objects.Label(str, "20px", 
                                  "Intubli_q", color, this.results.x, y, true);
        }
    }
